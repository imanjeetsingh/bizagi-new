...
$(".cardSection").each(function() {
    ...
    var removePagination = false;

    if (window.screen.width > 1023) {
        if (cardRDes == 1) {
            cardLoop = cardslideCount > cardCDes;
        }
        removePagination = !(cardslideCount > cardRDes * cardCDes);

    } else if (window.screen.width > 767) {
        if (cardRTab == 1) {
            cardLoop = cardslideCount > cardCTab;
        }
        removePagination = !(cardslideCount > cardRTab * cardCTab);
